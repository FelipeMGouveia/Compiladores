 ...
 * <ul>
 *   <li>{@link br.poli.ecomp.compiladores.notC.impl.DeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link br.poli.ecomp.compiladores.notC.impl.DeclarationImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeclarationImpl extends MinimalEObjectImpl.Container implements Declaration
{
  ...
  {
    return NotCPackage.Literals.DECLARATION;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetValue(RDeclaration newValue, NotificationChain msgs)
  {
    RDeclaration oldValue = value;
    value = newValue;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NotCPackage.DECLARATION__VALUE, oldValue, newValue);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setValue(RDeclaration newValue)
  {
    if (newValue != value)
    {
      NotificationChain msgs = null;
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NotCPackage.DECLARATION__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NotCPackage.DECLARATION__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NotCPackage.DECLARATION__VALUE, newValue, newValue));
  }
